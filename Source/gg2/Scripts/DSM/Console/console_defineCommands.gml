...
console_print('The round has been ended.')
", "
console_print('Syntax: endRoundR')
console_print('Use: End the round in Red team's favour.')
")

console_addCommand("endRoundB", "
    if not global.isHost{
        console_print('Only the host can use this command.')
        exit
    }
    ...
    console_print('The round has been ended.')
", "
console_print('Syntax: endRoundB')
console_print('Use: End the round in Blue team's favour.')
")
