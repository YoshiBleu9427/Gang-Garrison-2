//This describes sniper fighting in all situations
if (ds_list_empty(directionList) or task != 'default'){
...
and collision_line(object.x,object.y,Target_x,Target_y,TeamGate,true,true)<0
and collision_line(object.x,object.y,Target_x,Target_y,ControlPointSetupGate,true,true)<0
and collision_line(object.x,object.y,Target_x,Target_y,IntelGate,true,true)<0
and collision_line(object.x,object.y,Target_x,Target_y,BulletWall,true,true)<0)
{
    doesnt_collide = true
    ...
    for (i=0; i<ds_list_size(list_of_char)-1; i+=1){
        if collision_line(object.x, object.y, Target_x, Target_y, ds_list_find_value(list_of_char, i,), true, true){
            ...
            i = 10000//You'll never have that many players.
        }
    }
