...
for(i=0; i<ds_list_size(nodeList); i+=1){ // Get rid of long stairs, save the edges (again).
    node = ds_list_find_value(nodeList, i)
    
    /*if collision_circle(node.x, node.y, 5, SpawnRoom, 1, 1) Bots sometimes get stuck in the spawn room
    {
        with node
        {
