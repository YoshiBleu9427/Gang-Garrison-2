...
for (i=1; i<= global.totalControlPoints; i+=1)
{
    ...
    if global.dsmHUDs==1{
        ...
        draw_set_halign(fa_center);
        draw_set_color(c_black);
        draw_text_transformed(xoffset+xsize/2+13, yoffset+ysize-43, string(ArenaControlPoint.cappers),1.5,1.5,0);
    }else{
