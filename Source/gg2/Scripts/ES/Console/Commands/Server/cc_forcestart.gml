...
console_print('Round has been force-started.')
", "
console_print('Syntax: forcestart')
console_print('Forces a round to start, regardless of ready status of all players.')
")
