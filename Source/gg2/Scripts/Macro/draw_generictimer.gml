...
if (mode == 0)
{
    ...
    else
    {
        ...
        {
            draw_sprite_ext(timerSprite,floor(global.setupTimer/1800*12),xoffset+xsize/2+39,yoffset+30,3,3,0,c_white,1);
        ...
        {
            draw_sprite_ext(timerSprite,floor(countdown/timeLimit*12),xoffset+xsize/2+39,yoffset+30,3,3,0,c_white,1);
